    ...
    <>
      ...
      <div className="navigation">
        <div className="menu_icon">
          ...
          <div className="hambeger" onClick={() => setToggle(!toggle)}>
            {
              toggle ? (<svg id="close_icon" className="text_gray w-6 h-6 text-gray-800 dark:text-white" width="20" height="20" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
          ...
          {
            toggle ? (<ul className="nav_menu_sidbar">
              <li>
                <NavLink
                  className={(Link) => Link.isActive ? 'text_danger' : 'text_gray'}
                  to='/'>خانه</NavLink>
              </li>
              <li>
                <NavLink
              ...
              <li>
                <NavLink
                  className={(Link) => Link.isActive ? 'text_danger' : 'text_gray'}
                  to="/contact">ارتباط با ما</NavLink>
              </li>
        ...
        <div className="link-navigation">
          <Link to="/signin" className="sign-in"> ثبت نام</Link>
