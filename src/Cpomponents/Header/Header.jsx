      ...
      <div className="main-header">
        <div className="container_site">
          ...
          <div className="header_bottom">
            <div className="content_left_header_bottom ">

              <img className="desktop" src="./img/pizza.png" />
            </div>
            <div className="content_right_header_bottom">
              <h1>غذای مورد علاقه ات رو سفارش بده </h1>
              <p>پیتزا ها مزه های مختلفی دارند تا حالا پیتزا پنیری بیف رو امتحان کردید؟</p>
              <img className="mobile" src="./img/pizza.png" />
              
              <div className="order_food">
                <div className="action_order">

                  <Link className="order_btn" to={'/menu'}>
